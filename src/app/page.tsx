...
export default function LandingPage() {
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6">
    ...
    <div className="text-center mb-8">
      ...
      <h3 className="text-lg font-semibold text-foreground mb-2">Lav Raj</h3>
      <p className="text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
        FullStack Developer || Software Developer || Java || Python  || Web Development || Competitive Programmer
      </p>
    </div>
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
      <div className="flex items-center text-sm text-muted-foreground">
        ...
        <a href="mailto:lavraj0015@gmail.com" className="hover:text-foreground transition-colors">
          lavraj0015@gmail.com
        </a>
      </div>
      <div className="flex items-center text-sm text-muted-foreground">
        <Phone className="h-4 w-4 mr-2 text-green-500" />
        <a href="tel:+919155286784" className="hover:text-foreground transition-colors">
          +91 9155286784
        </a>
      </div>
    </div>
    ...
    <div className="flex justify-center items-center space-x-6 mb-8">
      <a 
        href="mailto:lavraj0015@gmail.com" 
      ...
      <a 
        href="https://linkedin.com/in/lav-raj-7a1a95257/" 
        target="_blank" 
      ...
      <a 
        href="https://instagram.com/lav_raj_0.15" 
        target="_blank" 
        rel="noopener noreferrer" 
